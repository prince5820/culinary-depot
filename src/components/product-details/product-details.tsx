...
const ProductDetails = () => {
  ...
  const productThumbnails = [
    {
      imageUrl: "/src/assets/images/product-view-thumbnail-img-1.jpg",
      alt: "Product View Thumbnail",
    },
    {
      imageUrl: "/src/assets/images/product-view-thumbnail-img-2.jpg",
      alt: "Product View Thumbnail",
    },
    {
      imageUrl: "/src/assets/images/product-view-thumbnail-img-3.jpg",
      alt: "Product View Thumbnail",
    },
    {
      imageUrl: "/src/assets/images/product-view-thumbnail-img-4.jpg",
      alt: "Product View Thumbnail",
    },
    {
      imageUrl: "/src/assets/images/product-view-thumbnail-img-5.jpg",
      alt: "Product View Thumbnail",
      isYoutube: true,
    },
  ];
  ...
  return (
    <Grid2 container spacing={2} className="wrapper-product-details">
      <Grid2 size={6}>
        <Box
          component="img"
          src="/src/assets/images/scotsman-brand-name-logo.jpg"
          alt="Brand Name Logo"
        />
        <Box
          component="img"
            ...
            <Grid2 key={index}>
              <Link to="#" className="thumbnail-image-link">
                ...
                {thumbnail.isYoutube && (
                  <Box
                    component="img"
                    src="/src/assets/images/product-view-thumbnail-img-youtube-play.webp"
      ...
      <Grid2 size={6}>
        ...
        <Box className="free-shipping-credit-key-section">
          <Box
            component="img"
            src="/src/assets/images/freeshipping.webp"
          ...
          <Link to="#" className="credit-key">
            <Typography>
              ...
              <Box
                component="img"
                src="/src/assets/images/credit-key.png"
                alt="Credit Key"
        ...
        <Box
          component="img"
          src="/src/assets/images/cd-instock-new-icon.jpg"
          alt="In stock icon"
          sx={{
            height: "26.55px",
          }}
